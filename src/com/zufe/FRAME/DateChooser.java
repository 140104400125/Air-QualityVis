...
public class DateChooser extends JPanel {
	...
	public int getSelectYear(){
		return select.get(Calendar.YEAR);
	}
	...
	public int getSelectDay(){
		day=select.get(Calendar.DAY_OF_MONTH);
		return day;
	}
	/** 
	 * 是否允许用户选择 
	...
	private void commit() {
		...
		}else if(showDate instanceof JMenuItem){
			((JMenuItem) showDate).setText(sdf.format(select.getTime()));
		}
		hidePanel();
	}
	...
	private class JP2 extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			Font font1 = new Font("宋体", Font.PLAIN,10);
			g.setFont(font1);
	...
	private class JP4 extends JPanel {
		...
		public JP4() {
			...
			jl.setToolTipText("Click on the select date today");
	...
	/*public static void main(String[] args) {
		...
		JMenuItem showDate2 = new JMenuItem("单击选择日期");
